...
date = “2026-07-06 16:06:42+03:00”
...
The Host-Controller Interface (HCI) is the specification for how the operating system (the host, in our case, is Haiku OS) communicates with the Bluetooth controller. The Bluetooth controller is basically the firmware on the Bluetooth chip. So, it’s vital to implement at least most of the mandatory HCI commands and events from the Bluetooth specification for Bluetooth to function properly. HCI commands and events were mostly outdated, dating back to version 2.0 or 2.1, so updating them was the first step to get the Bluetooth stack back to life.
